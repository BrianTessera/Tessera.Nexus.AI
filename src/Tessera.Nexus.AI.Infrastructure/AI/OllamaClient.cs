...
public sealed class OllamaClient : IOllamaClient
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        if (!response.IsSuccessStatusCode)
        {
            ...
            throw new InvalidOperationException(
                $"Ollama generation failed. Status: {(int)response.StatusCode} {response.ReasonPhrase}. Response: {errorText}");
        }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        if (!response.IsSuccessStatusCode)
        {
            ...
            throw new InvalidOperationException(
                $"Unable to retrieve Ollama models. Status: {(int)response.StatusCode} {response.ReasonPhrase}. Response: {errorText}");
        }
